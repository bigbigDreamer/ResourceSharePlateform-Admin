           ...
           <Col>
               <Table :columns="columns" :data="data">
                   ...
                   <template slot-scope="{ row, index }" slot="projectDescribe">
                       ...
                       <span v-else>{{ row.projectDescribe }}</span>
                   </template>
                   ...
                   <template slot-scope="{ row, index }" slot="projectRequirements">
                       ...
                       <span v-else>{{ row.projectRequirements }}</span>
                   </template>
    ...
    export default {
        ...
        methods: {
            ...
            handleSave (index) {
                ...
                this.data[index].projectDescribe = this.editProjectDescribe;
                this.data[index].projectRequirements = this.editProjectRequirements;
