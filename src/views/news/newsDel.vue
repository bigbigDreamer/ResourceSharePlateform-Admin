            ...
            <Col>
                <Table :columns="columns" :data="data">
                    ...
                    <template slot-scope="{ row, index }" slot="isrecommend">
                        <i-switch size="large" v-model="!!row.isrecommend" disabled>
                    ...
                    <template slot-scope="{ row, index }" slot="action">
                        <div v-if="editIndex === index">
                            <Button @click="handleSave(row,index)">删除</Button>
    ...
    export default {
        ...
        methods: {
            ...
            handleSave(row, index) {
                ...
                this.editIndex = -1;
                this.$ajax.post('http://websitdevelopment.cn:8081/news/deleteById', {
                    id: row.id,
                })
                    .then(data => {
                        //console.log(data);
